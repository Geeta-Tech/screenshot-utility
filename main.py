...
file_option = Button(win, text="select", font=('Time New Roman', 15), cursor='hand2',command=choose_folder)  # hand2 is a cursor pointer
file_option.place(x=700, y=15, height=50, width=90)

msg_file = Entry(win, textvariable=msg_file, font=('Time New Roman', 15), state="readonly")
msg_file.place(x=50, y=85, height=50, width=350)

entry_file_name = Entry(win, textvariable=file_var, font=('Time New Roman', 15))
entry_file_name.place(x=410, y=85, height=50, width=340)
